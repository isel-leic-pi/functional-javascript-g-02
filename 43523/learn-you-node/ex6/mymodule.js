...
module.exports = function(pathDir,extname,cb){
    fs.readdir(pathDir,(err,data)=>{
        if(err) return cb(err)
        
        data = data.filter(file => pathFile.extname(file)== '.'+ extname)
...
/* You must write a module file (mymodule.js) to do most of the work. The
module must export a single function that takes three arguments: the
directory name, the filename extension string and your callback functio */